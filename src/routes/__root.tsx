...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Swahili Design Lab" },
      { property: "og:site_name", content: "Swahili Design Lab" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Swahili Design Lab",
          url: "https://swahilidesignlab.co.ke",
          description:
            "Sustainable fashion marketplace offering upcycled and circular design products from Kenya.",
        }),
      },
    ],
  }),
